...
INSERT INTO `inv_tipos_alicuota` (`CODIGO_TIPO_ALIC`, `PASIVO`, `FECHA_REGISTRO`, `USUARIO_REGISTRO`, `NOMBRE_TIPO_ALIC`, `OBS_TIPO_ALIC`, `TIPO_MUESTRA`, `TEMPERATURA`, `USO_ALIC`, `VOLUMEN`, `VOLUMEN_MAX`, `VOLUMEN_MIN`) VALUES ('00000000-0586-034f-0000-00001a5dae20', '0', '2017-03-29 07:59:59', 'admin', '1b', '', 'SUERO', -80, 'PCR', 140,500,50);
INSERT INTO `inv_tipos_alicuota` (`CODIGO_TIPO_ALIC`, `PASIVO`, `FECHA_REGISTRO`, `USUARIO_REGISTRO`, `NOMBRE_TIPO_ALIC`, `OBS_TIPO_ALIC`, `TIPO_MUESTRA`, `TEMPERATURA`, `USO_ALIC`, `VOLUMEN`, `VOLUMEN_MAX`, `VOLUMEN_MIN`) VALUES ('00000000-0586-034f-0000-00001a5e318d', '0', '2017-03-29 08:00:32', 'admin', '1c', '', 'SUERO', -80, 'PCR', 140,500,50);
INSERT INTO `inv_tipos_alicuota` (`CODIGO_TIPO_ALIC`, `PASIVO`, `FECHA_REGISTRO`, `USUARIO_REGISTRO`, `NOMBRE_TIPO_ALIC`, `OBS_TIPO_ALIC`, `TIPO_MUESTRA`, `TEMPERATURA`, `USO_ALIC`, `VOLUMEN`, `VOLUMEN_MAX`, `VOLUMEN_MIN`) VALUES ('00000000-0586-034f-0000-00001a5e6239', '0', '2017-03-29 08:00:45', 'admin', '1d', '', 'SUERO', -80, 'PCR', 140,500,50);
...
INSERT INTO `inv_mensajes` (`messageKey`, `es`, `catPasive`, `isCat`, `orden`) VALUES ( 'aliNotInListBox', 'Alicuota no existe para esta caja','0','0',0);
...
INSERT INTO `inv_mensajes` (`messageKey`, `es`, `catPasive`, `isCat`, `orden`) VALUES ( 'posAvailable', 'Disponibilidad','0','0',0);
INSERT INTO `inv_mensajes` (`messageKey`, `es`, `catPasive`, `isCat`, `orden`) VALUES ( 'boxAvailable', 'Cajas disponibles','0','0',0);
INSERT INTO `inv_mensajes` (`messageKey`, `es`, `catPasive`, `isCat`, `orden`) VALUES ( 'required', 'es requerido!','0','0',0);
...
/* Búsqueda de muestras en simlab*/
INSERT INTO `inv_mensajes` (`messageKey`, `es`, `catPasive`, `isCat`, `orden`) VALUES ( 'simlab_menu', 'Simlab','0','0',0);
INSERT INTO `inv_mensajes` (`messageKey`, `es`, `catPasive`, `isCat`, `orden`) VALUES ( 'weight', 'Peso','0','0',0);
INSERT INTO `inv_mensajes` (`messageKey`, `es`, `catPasive`, `isCat`, `orden`) VALUES ( 'separated', 'Separada','0','0',0);
INSERT INTO `inv_mensajes` (`messageKey`, `es`, `catPasive`, `isCat`, `orden`) VALUES ( 'num_desc', 'Num Desc.','0','0',0);
INSERT INTO `inv_mensajes` (`messageKey`, `es`, `catPasive`, `isCat`, `orden`) VALUES ( 'user_output', 'Usuario salida','0','0',0);
INSERT INTO `inv_mensajes` (`messageKey`, `es`, `catPasive`, `isCat`, `orden`) VALUES ( 'use', 'Uso','0','0',0);
INSERT INTO `inv_mensajes` (`messageKey`, `es`, `catPasive`, `isCat`, `orden`) VALUES ( 'user_use', 'Usuario uso','0','0',0);
INSERT INTO `inv_mensajes` (`messageKey`, `es`, `catPasive`, `isCat`, `orden`) VALUES ( 'use_date', 'Fecha uso','0','0',0);
INSERT INTO `inv_mensajes` (`messageKey`, `es`, `catPasive`, `isCat`, `orden`) VALUES ( 'aliquot_reg', 'Registro Alicuota','0','0',0);
INSERT INTO `inv_mensajes` (`messageKey`, `es`, `catPasive`, `isCat`, `orden`) VALUES ( 'table', 'Tabla','0','0',0);
INSERT INTO `inv_mensajes` (`messageKey`, `es`, `catPasive`, `isCat`, `orden`) VALUES ( 'register_date', 'Fecha Registro','0','0',0);
INSERT INTO `inv_mensajes` (`messageKey`, `es`, `catPasive`, `isCat`, `orden`) VALUES ( 'reg_use_alic', 'Registro Uso Alicuotas','0','0',0);
INSERT INTO `inv_mensajes` (`messageKey`, `es`, `catPasive`, `isCat`, `orden`) VALUES ( 'alic_output2', 'Salida alicuotas','0','0',0);
...
/* Solicitud muestra*/
INSERT INTO `inv_mensajes` (`messageKey`, `es`, `catPasive`, `isCat`, `orden`) VALUES ( 'sample_request', 'Solicitud de Muestras','0','0',0);
INSERT INTO `inv_mensajes` (`messageKey`, `es`, `catPasive`, `isCat`, `orden`) VALUES ( 'request_date', 'Fecha de Solicitud','0','0',0);
INSERT INTO `inv_mensajes` (`messageKey`, `es`, `catPasive`, `isCat`, `orden`) VALUES ( 'resp_request', 'Responsable de la Solicitud','0','0',0);
INSERT INTO `inv_mensajes` (`messageKey`, `es`, `catPasive`, `isCat`, `orden`) VALUES ( 'approvedBy', 'Autorizado por','0','0',0);
INSERT INTO `inv_mensajes` (`messageKey`, `es`, `catPasive`, `isCat`, `orden`) VALUES ( 'code', 'Código','0','0',0);
INSERT INTO `inv_mensajes` (`messageKey`, `es`, `catPasive`, `isCat`, `orden`) VALUES ( 'aliVol2', 'Volumen Alicuota','0','0',0);
INSERT INTO `inv_mensajes` (`messageKey`, `es`, `catPasive`, `isCat`, `orden`) VALUES ( 'subAliVol', 'Volumen Sub-Alicuota','0','0',0);
...
INSERT INTO `inv_mensajes` (`messageKey`, `es`, `catPasive`, `isCat`, `orden`) VALUES ( 'initDate', 'Fecha Inicio','0','0',0);
...
INSERT INTO `inv_mensajes` (`messageKey`, `es`, `catPasive`, `isCat`, `orden`) VALUES ( 'aliActive', 'Alicuotas activas','0','0',0);
INSERT INTO `inv_mensajes` (`messageKey`, `es`, `catPasive`, `isCat`, `orden`) VALUES ( 'aliUsed', 'Uso de Alicuotas','0','0',0);
INSERT INTO `inv_mensajes` (`messageKey`, `es`, `catPasive`, `isCat`, `orden`) VALUES ( 'aliSent', 'Alicuotas enviadas','0','0',0);
