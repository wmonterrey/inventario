                        ...
                        <ul class="page-breadcrumb breadcrumb">
                            <li>
                                ...
                                <i class="fa fa-angle-right"></i> <a
                                    href="<spring:url value="/alictransfer/transferAlic" htmlEscape="true "/>"><spring:message
                                    code="transfer_alic"/></a>
                            </li>
                        </ul>
                                ...
                                <form action="#" autocomplete="off" id="exit_form1"
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <select data-placeholder="<spring:message code="select" /> <spring:message code="centerName" />"
                                                        class="form-control" id="center"
                                                        name="center">
                                                    <option value=""></option>
                                                    <c:forEach items="${centers}" var="cen">
                                                        <option value="${cen.centerCode}"><spring:message
                                                                code="${cen.centerName}"/></option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                        </div>
...
<spring:url value="/resources/scripts/alics/alic-transfer-process.js" var="transferScript"/>
<script src="${transferScript}" type="text/javascript"></script>
...
<script>
    jQuery(document).ready(function () {
        ...
        CreateTransfer.init(parametros);
