						...
						<div class="portlet-body">
							...
							<thead>
								<tr>
									...
									<th><spring:message code="studyName" /></th>
									<th><spring:message code="studyPattern" /></th>
							...
							<c:forEach items="${estudios}" var="estudio">
								<tr>
									<spring:url value="/super/studies/viewStudy/{study}/"
										var="estudioUrl">
										<spring:param name="study" value="${estudio.studyCode}" />
									</spring:url>
									...
									<td><a href="${fn:escapeXml(estudioUrl)}"><c:out value="${estudio.studyCode}" /></a></td>
									<td><a href="${fn:escapeXml(estudioUrl)}"><c:out value="${estudio.studyName}" /></a></td>
									<td><c:out value="${estudio.studyPattern}" /></td>
									<c:choose>
									...
									<td>
										...
										<c:choose>
										<c:when test="${estudio.pasive=='0'.charAt(0)}">
											<a data-toggle="modal" data-estudio="${estudio.studyName}" data-id= "${fn:escapeXml(disableUrl)}" class="btn btn-default btn-xs desact"><i class="fa fa-trash-o"></i></a>
										</c:when>
										<c:otherwise>
											<a data-toggle="modal" data-estudio="${estudio.studyName}" data-id= "${fn:escapeXml(enableUrl)}" class="btn btn-default btn-xs act"><i class="fa fa-check"></i></a>
										</c:otherwise>
										</c:choose>
									</td>
								</tr>
