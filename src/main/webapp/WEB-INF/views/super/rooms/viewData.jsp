...
<spring:url value="/super/rooms/editRoom/{room}/"	var="editUrl">
	<spring:param name="room" value="${room.roomCode}" />
</spring:url>
<spring:url value="/super/rooms/act/disable2/{room}/" var="disableUrl">
	<spring:param name="room" value="${room.roomCode}" />
</spring:url>
<spring:url value="/super/rooms/act/enable2/{room}/"	var="enableUrl">
	<spring:param name="room" value="${room.roomCode}" />
</spring:url>
				...
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						<li>
							...
							<i class="fa fa-angle-right"></i> <a href="<spring:url value="/super/rooms/" htmlEscape="true "/>"><spring:message code="superrooms" /></a> <i class="fa fa-angle-right"></i> <a href="<spring:url value="/super/rooms/viewRoom/${room.roomCode}/" htmlEscape="true "/>">${room.roomCode}</a>
						</li>
					</ul>
					...
					<div class="portlet">
						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="btn-group">
									<spring:url value="/super/rooms/"	var="listRoom"/>
									<button id="lista_cuartos" onclick="location.href='${fn:escapeXml(listRoom)}'" class="btn btn-info">
									<spring:message code="superrooms" /> <i class="fa fa-reply"></i>
									</button>
								</div>
								<div class="btn-group pull-right">
									...
									<ul class="dropdown-menu pull-right">
										...
										<c:choose>
											<c:when test="${room.pasive=='0'.charAt(0)}">
												<li>
													<a data-toggle="modal" data-cuarto="${room.roomName}" data-id= "${fn:escapeXml(disableUrl)}" class="desact"><i class="fa fa-trash-o"></i> <spring:message code="disable" /></a>
												</li>
											</c:when>
											<c:otherwise>
												<li>
													<a data-toggle="modal" data-cuarto="${room.roomName}" data-id= "${fn:escapeXml(enableUrl)}" class="act"><i class="fa fa-check"></i> <spring:message code="enable" /></a>
												</li>
											</c:otherwise>
										</c:choose>
									</ul>
							...
							<form class="form-horizontal">
								<div class="form-body">
									<h3 class="form-section"><spring:message code="roomCode" />: <c:out value="${room.roomCode}" /></h3>
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label class="control-label col-md-3"><spring:message code="roomName" />:</label>
												<div class="col-md-9">
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label class="control-label col-md-3"><spring:message code="centerName" />:</label>
												<div class="col-md-9">
													<p class="form-control-static">
														 <c:out value="${room.roomCenter.centerName}" />
													</p>
												</div>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label class="control-label col-md-3"><spring:message code="roomObs" />:</label>
												<div class="col-md-9">
													<p class="form-control-static">
														 <c:out value="${room.roomObs}" />
													</p>
												</div>
											</div>
										</div>
