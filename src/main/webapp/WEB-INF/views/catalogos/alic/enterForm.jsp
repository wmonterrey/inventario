...
<div class="page-content-wrapper">
	<div class="page-content-wrapper">
		<div class="page-content">
				...
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						<li>
							...
							<i class="fa fa-angle-right"></i> <a href="<spring:url value="/catalog/alics/" htmlEscape="true "/>"><spring:message code="catalogalic" /></a> <i class="fa fa-angle-right"></i> <a href="<spring:url value="/catalog/alics/editAlicType/${alicType.alicTypeCode}/" htmlEscape="true "/>">${alicType.alicTypeCode}</a>
						</li>
					</ul>
			...
			<!-- END PAGE HEADER-->
			<!-- BEGIN PAGE CONTENT-->
			<spring:url value="/catalog/alics/newAlicType" var="newAlicTypeUrl"></spring:url>
			<spring:url value="/catalog/alics/" var="alicTypeUrl"></spring:url>
			<c:set var="alicTypeCreated"><spring:message code="process.success" /></c:set>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="portlet">
						...
						<form action="#" autocomplete="off" id="add-alicType-form" class="form-horizontal">
								<div class="form-body">
									...
									<div class="form-group">
										<label class="control-label col-md-3"><spring:message code="alicTypeCode" />
										<span class="required">
											 *
										</span>
										</label>
