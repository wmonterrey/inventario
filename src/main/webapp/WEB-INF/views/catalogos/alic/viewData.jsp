...
<spring:url value="/catalog/alics/editAlicType/{alicType}/"	var="editUrl">
	<spring:param name="alicType" value="${alicType.alicTypeCode}" />
</spring:url>
<spring:url value="/catalog/alics/act/disable2/{alicType}/" var="disableUrl">
	<spring:param name="alicType" value="${alicType.alicTypeCode}" />
</spring:url>
<spring:url value="/catalog/alics/act/enable2/{alicType}/"	var="enableUrl">
	<spring:param name="alicType" value="${alicType.alicTypeCode}" />
</spring:url>
				...
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						<li>
							...
							<i class="fa fa-angle-right"></i> <a href="<spring:url value="/catalog/alics/" htmlEscape="true "/>"><spring:message code="catalogalic" /></a> <i class="fa fa-angle-right"></i> <a href="<spring:url value="/catalog/alics/viewAlicType/${alicType.alicTypeCode}/" htmlEscape="true "/>">${alicType.alicTypeCode}</a>
						</li>
					</ul>
					...
					<div class="portlet">
						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="btn-group">
									<spring:url value="/catalog/alics/"	var="listAlicType"/>
									<button id="lista_alicuotas" onclick="location.href='${fn:escapeXml(listAlicType)}'" class="btn btn-info">
									<spring:message code="catalogalic" /> <i class="fa fa-reply"></i>
									</button>
								</div>
								<div class="btn-group pull-right">
									...
									<ul class="dropdown-menu pull-right">
										...
										<c:choose>
											<c:when test="${alicType.pasive=='0'.charAt(0)}">
												<li>
													<a data-toggle="modal" data-alictype="${alicType.alicTypeName}" data-id= "${fn:escapeXml(disableUrl)}" class="desact"><i class="fa fa-trash-o"></i> <spring:message code="disable" /></a>
												</li>
											</c:when>
											<c:otherwise>
												<li>
													<a data-toggle="modal" data-alictype="${alicType.alicTypeName}" data-id= "${fn:escapeXml(enableUrl)}" class="act"><i class="fa fa-check"></i> <spring:message code="enable" /></a>
												</li>
											</c:otherwise>
										</c:choose>
									</ul>
							...
							<form class="form-horizontal">
								<div class="form-body">
									<h3 class="form-section"><spring:message code="alicTypeCode" />: <c:out value="${alicType.alicTypeCode}" /></h3>
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label class="control-label col-md-3"><spring:message code="alicTypeName" />:</label>
												<div class="col-md-9">
													<p class="form-control-static">
														 <c:out value="${alicType.alicTypeName}" />
													</p>
												</div>
											</div>
										</div>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label class="control-label col-md-3"><spring:message code="alicTypeUse" />:</label>
												<div class="col-md-9">
													<p class="form-control-static">
														 <c:out value="${alicType.alicTypeUse}" />
													</p>
												</div>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label class="control-label col-md-3"><spring:message code="alicTypeTemp" />:</label>
												<div class="col-md-9">
													<p class="form-control-static">
														 <c:out value="${alicType.alicTypeTemp}" />
													</p>
												</div>
											</div>
										</div>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label class="control-label col-md-3"><spring:message code="alicTypeSample" />:</label>
												<div class="col-md-9">
													<p class="form-control-static">
														 <c:out value="${alicType.alicTypeSample}" />
													</p>
												</div>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label class="control-label col-md-3"><spring:message code="alicTypeVol" />:</label>
												<div class="col-md-9">
													<p class="form-control-static">
														 <c:out value="${alicType.alicTypeVol}" />
													</p>
												</div>
											</div>
										</div>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="col-md-9">
													<p class="form-control-static">
														 <c:out value="${alicType.alicTypeObs}" />
													</p>
												</div>
											</div>
										</div>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="col-md-9">
													<p class="form-control-static">
														 <c:out value="${alicType.recordUser}" />
													</p>
												</div>
											</div>
										</div>
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="col-md-9">
													<p class="form-control-static">
														<c:out value="${alicType.recordDate}" />
													</p>
												</div>
											</div>
										</div>
...
<script>
	jQuery(document).ready(function() {
		...
		$(".act").click(function(){ 
        	...
        	$('#cuerpo').html('<h3>'+"${habilitar}"+' '+$(this).data('alictype')+'?</h3>');
        	$('#basic').modal('show');
        });
        ...
        $(".desact").click(function(){ 
        	$('#accionUrl').val($(this).data('id'));
        	$('#titulo').html('<h2 class="modal-title">'+"${confirmar}"+'</h2>');
        	$('#cuerpo').html('<h3>'+"${deshabilitar}"+' '+$(this).data('alictype')+'?</h3>');
        	$('#basic').modal('show');
        });
