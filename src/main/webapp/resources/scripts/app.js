...
var App = function () {
    ...
    var handleTheme = function () {
        ...
        "boxed"==localStorage.getItem("inven-layout")?(
        ...
        "fixed"==localStorage.getItem("inven-sidebar")?(
        		$("body").addClass("page-sidebar-fixed"),
        		$('.sidebar-option', panel).val("fixed")):(
        				$("body").removeClass("page-sidebar-fixed"),
        				$('.sidebar-option', panel).val("default"));
        
		"fixed"==localStorage.getItem("inven-header")?(
		...
		"fixed"==localStorage.getItem("inven-footer")?(
		...
		//sidebar position
        if (App.isRTL()) {
            if (localStorage.getItem("inven-sbpos") === 'left') {
            ...
            if (localStorage.getItem("inven-sbpos") === 'right') {
                $("body").addClass("page-sidebar-reversed");
                $('.sidebar-pos-option', panel).val("right");
            } else {
                $("body").removeClass("page-sidebar-reversed");
        ...
        var setLayout = function () {
            ...
            localStorage.setItem("inven-layout",layoutOption);
            var sidebarOption = $('.sidebar-option', panel).val();
            localStorage.setItem("inven-sidebar",sidebarOption);
            var headerOption = $('.header-option', panel).val();
            localStorage.setItem("inven-header",headerOption);
            var footerOption = $('.footer-option', panel).val();
            localStorage.setItem("inven-footer",footerOption);
            var sidebarPosOption = $('.sidebar-pos-option', panel).val();
            localStorage.setItem("inven-sbpos",sidebarPosOption);
        ...
        var setColor = function (color) {
            ...
            localStorage.setItem("inv-style-color",color);
        };
        ...
        null!=localStorage.getItem("inv-style-color")?setColor(localStorage.getItem("inv-style-color")):setColor("default");
    };
    //* END:CORE HANDLERS *//
