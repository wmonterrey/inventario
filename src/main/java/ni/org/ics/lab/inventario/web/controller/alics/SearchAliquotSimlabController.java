...
public class SearchAliquotSimlabController {

    private static final Logger logger = LoggerFactory.getLogger(SearchAliquotSimlabController.class);
    ...
    public String initCreation(Model model) {
        ...
        if (usuario.getUserCenter()!=null){
            ...
            return "alics/searchAliquotFormSimlab";
        }
        else{
            return "403";
        }
