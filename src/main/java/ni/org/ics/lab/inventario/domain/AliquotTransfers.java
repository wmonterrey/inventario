...
/**
 * Simple objeto de dominio que representa el traslado de alicuota(s)
 * 
 * 
...
@Entity
@Table(name = "inv_traslado_alicuotas", catalog = "inventario", uniqueConstraints={@UniqueConstraint(columnNames = {"CODIGO_ALIC","CODIGO_ESTUDIO","PASIVO"})})
